...
| [examples/frontend-design](examples/frontend-design) | Frontend Design — production-grade UI with enforced design constraints (palette limits, type scale, spacing tokens, motion budgets). Includes SKILL.md + indie film festival hero section output demo | Building distinctive frontend interfaces |
